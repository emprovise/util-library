...
public class PropertiesUtil {
     ...
     *
     * @param propsName
     * 		Name of the property file in the class path
     * @return
     ...
     * @param loader
     * 		Instance of the class loader relative to which the property file needs to be loaded
     * @return
     * 		Properties fetched from the specified property file
     * @throws IOException
     */
     ...
     * @return
     * 		Formatted {@link String} containing all the system and environment properties.
     */
