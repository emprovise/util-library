...
public class FileUtil {
     ...
     * @param parameter The name of the parameter to be read from the file.
     * @return {@link String}
     ...
     *
     * @param txtFile The full name of the file  to write to, including the path if file is located outside the class path.
     * @param params  The name-value pairs to be written to the file similar to a property file.
     * @throws IOException
     * @throws Exception
     */
     ...
     *
     * @param file {@link File} who's parent directory needs to be created.
     */
     ...
     *
     * @param filename The full name of the file to write to, including the path if file is located outside the class path.
     * @param text     The text to be written to the file.
     * @param doAppend If true then the text is appended to the end of the file else the text is overwritten.
     * @throws IOException
     */
     ...
     *
     * @param filename The full name of the file to write to, including the path if file is located outside the class path.
     * @param textList An {@link ArrayList} of lines to write to the file.
     * @param doAppend If true then the text is appended to the end of the file else the text is overwritten.
     * @throws IOException
     */
     ...
     *
     * @param filename The full name of the file to be read including the path if file is located outside the class path.
     * @return An {@link ArrayList} of lines read from the file.
     * @throws IOException
     */
     ...
     *
     * @param directory   {@link File} to search for the specified filename.
     * @param fileName    Name of the file to be searched in the directory.
     * @param parentLevel Parent directory level until which search should be performed.
     * @return Directory in which the specified filename is found.
     */
     ...
     * directory.
     *
     * @param source      {@link File} specifying source file along with full path.
     * @param destination {@link File} specifying destination file along with full path.
     * @throws IOException
     */
     ...
     * name.
     *
     * @param directory      {@link File} specifying the directory containing the files to be deleted.
     * @param ignoreFilename {@link String} specifying the file name to be ignored while deletion.
     */
