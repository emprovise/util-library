...
public class FileLockUtil {
     ...
     *
     * @param filePath Full file path for the {@link File} to Lock
     * @throws IOException
     ...
     *
     * @param params A {@link Map} Object with the name/value pairs of the properties to write to the lock file.
     * @throws Exception
     */
     ...
     *
     * @param parameter The name of the parameter to read from the lock file.
     * @return Value of the specified parameter name from the lock file
     * @throws Exception
     */
     ...
     *
     * @param lockFile The lock {@link File} to write on.
     * @param channel  The file channel associated with the specified lock file input stream
     * @param params   A {@link Map} Object with the name/value pairs of the properties to write to the lock file.
     * @throws IOException
     */
     ...
     *
     * @param lockFile  The lock {@link File} to read from.
     * @param channel   The file channel associated with the specified lock file input stream
     * @param parameter The name of the parameter to read from the lock file.
     * @return Value of the specified parameter name from the lock file
     * @throws IOException
